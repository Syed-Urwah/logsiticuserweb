...
export default function OrderTracking() {
    ...
    useMemo(()=>{
        console.log(confirmDrivers)
    },[confirmDrivers])

    useMemo(()=>{
        if(driverData){
            setDriverLat(driverData.get_driver.driver_location.latitude);
            setDriverLong(driverData.get_driver.driver_location.longitude);
            setDriverStatus(driverData.status_id);
        }
        alert('data changes')
    },[confirmDrivers]);
