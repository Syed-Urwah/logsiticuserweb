                ...
                <div className='w-full mx-auto bg-slate-200 rounded-xl shadow-0 py-5 md:px-10 overflow-hidden md:max-w-2xl lg:max-w-5xl'>
                    <div className='md:flex md:justify-start'>
                        <div className='md:shrink-0'>
                            <label htmlFor="username" className='mt-4 block text-sm font-medium leading-6 text-gray-900 mr-2 pl-3'>ENTER USERNAME</label>

                        </div>
                        <div className="p-4 md:w-[600px] md:ms-1">
                            <input id="email" name="email" type="email" autoComplete="email" required className='w-full  rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-blue-300 placeholder:text-gray-400 outline-none focus:ring-1 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6 pl-2' placeholder='Enter Your USERNAME '/>
                    ...
                    <div className='md:flex md:justify-start'>
                        <div className='md:shrink-0'>
                            <label htmlFor="email" className='mt-4 block text-sm font-medium leading-6 text-gray-900 mr-2 pl-3'>ID CARD NO.</label>
