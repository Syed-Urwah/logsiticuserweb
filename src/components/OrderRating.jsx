...
const OrderRating = ({ driver, statusId }) => {
    ...
    const handleDriverRating = async () => {
        const url = process.env.NEXT_PUBLIC_SERVER_BASE_URL + "/api/customer/order/add_review";
        let bodyData = {
                    ...
                    <div className='flex justify-center mt-5'>
                        {
                            statusId >= 3 ?
                                ...
                                }} className='py-3 px-8 rounded-xl bg-[#a5a1f7] text-white'>Done</button>
                        }
                    </div>
                </DialogTrigger>
